// Hero Animation V2 Fixed - Copy this file to snack.expo.dev
...
export default function HeroAnimationV2() {
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      {/* Gradient Overlay - behind photo grid, in front of black background */}
      <GradientOverlay animationProgress={animationProgress} />

      {/* Photo Grid - above gradient overlay */}
      <Animated.FlatList
        ref={flatListRef}
        data={IMAGES_DATA}
      ...
      {/* Animated Hero Header V2 - on top of everything */}
